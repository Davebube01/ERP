    ...
    <>
        <div className='lg:flex bg-[#ecf5ff] min-h-[800px] px-6 py-24 items-center gap-1'>
            <div className='lg:w-[60%]'>
                <p className='text-6xl font-medium text-gray-800 font-[Roboto] md:text-center lg:text-left'>Connect with us</p>
                <p className='text-lg mt-8 text-[#7174a5] md:text-center lg:text-left md:w-[600px] lg:w-auto mx-auto'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In id magna malesuada tempor mitellus eget auctor parturient montes dolor.</p>
                ...
                <div className='md:flex lg:block items-center justify-evenly lg:w-full'>
                    <div className='flex mt-10 items-center '>
                        <div className='w-20 h-20 rounded-full bg-white flex justify-center items-center'>
                            <span className='text-5xl text-[#7174b9]'>
                ...
                <div className='flex mt-8 items-center md:justify-center lg:justify-start'>
                    ...
                    <div className='ml-6'>
                        ...
                        <p className='mt-1 text-2xl font-medium text-[#7174a5] font-[inter]'>ATL express, CBD, Abuja</p>
                    </div>
                </div>
